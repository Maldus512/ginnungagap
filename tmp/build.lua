...
return {
        ...
        action = function()
            ...
            local compileC = function(path)
                return buildConf:step(gcc {
                    input = path,
                    output = svadilfari.toExtension("o")
                })
            end
            ...
            local boot_stage2_checked_object = buildConf:pipe {
                ld {
                ...
                objcopy {
                    output = svadilfari.toExtension("bin"),
                },
            ...
            for _, source in pairs(svadilfari.listFilesOfType("main", "c")) do
                objects = objects .. " " .. compileC(source)
            end
            ...
            buildConf:pipe {
                ...
                buildConf:command("svad.lua uf2 $in $out") {
                    output = svadilfari.toExtension("uf2"),
                },
            }
    ...
    gdbrun = GDB .. " -x tools/debug/load-and-exit.gdb " .. ELF,
}
